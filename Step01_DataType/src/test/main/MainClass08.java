...
public class MainClass08 {
	public static void main(String[] args) {
		 ...
		 *  str 변수 안에 있는 문자를 모두 대문자(UpperCase)로 변환하여
		...
		// 위의 문자열에서 mimi라는 문자열을 
		// mama 라는 문자열로 교체해서 결과를 greet2 에 담아보세요
		String greet2=greet.replace("mimi", "mama");
		
		String message="My name is Kimgura";
		/*
		 *  1. 위의 문자열이 My 라는 문자열로 시작하는지 여부 (true or false)를
		 *  isStart 라는 변수에 담아보세요.
		 *  
		 *  2. 위의 문자열에서 i 가 문자열의 몇번째 인덱스 에위치하고있는지를 
		 *  index 라는 변수에 담아보세요.
		 */
