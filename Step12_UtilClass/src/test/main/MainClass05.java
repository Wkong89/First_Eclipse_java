...
public class MainClass05 {
	public static void main(String[] args) {
		// 1. Member 객체를 담을 수 있는 ArrayList 객체를 생성하여 참조값을
		//    members 라는 지역변수에 담아보세요.
		List<Member> members=new ArrayList<Member>();
		// 2. 3명의 회원정보를 Member 객체에 각각 담아보세요.
		//	  (Member 객체가 3개 생성되어야 함)
		...
		members.add(m3);
		/*
		 * 4. members List 객체에 담긴 내용을 이요하여 회원 목록을 아래와 같은 형식으로
		 *    반복문을 돌면서 출력해보세요.
		 *    
		 *    번호: 1, 이름: 김구라, 주소: 노량진
		 *    번호: 2, 이름: 해골, 주소: 행신동
